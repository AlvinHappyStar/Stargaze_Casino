      ...
      >
        <IconButton
          sx={{
            position: "absolute",
            width:
              selectedBetType === BET_TYPE_HEAD
                ? { xs: "120px", sm: "170px", md: "200px" }
                : { xs: "100px", sm: "150px", md: "165px" },
            border: selectedBetType === BET_TYPE_HEAD ? "5px solid gray" : "0",
            aspectRatio: "1",
            left: "0",
            top: "30%",
          ...
          onClick={() => {
            setSelectedBetType(BET_TYPE_HEAD);
            resetBetType(BET_TYPE_HEAD);
          }}
        />
        <IconButton
          sx={{
            position: "absolute",
            width:
              selectedBetType === BET_TYPE_TAIL
                ? { xs: "120px", sm: "170px", md: "200px" }
                : { xs: "100px", sm: "150px", md: "165px" },
            border: selectedBetType === BET_TYPE_TAIL ? "5px solid gray" : "0",
            aspectRatio: "1",
            right: "0",
            top: "30%",
            transform: "translate(30%, -30%)",
          ...
          onClick={() => {
            setSelectedBetType(BET_TYPE_TAIL);
            resetBetType(BET_TYPE_TAIL);
          }}
        />
      </Box>
    </>
